...
Config.PoliceJobs = { 'lspd', 'davispd', 'rangerpd', 'sandysheriff', 'paletosheriff', }
...
Config.Gerald = {
    ...
    Location = {
        Coords = vec3(-58.1513, -1531.4021, 34.3620),
        Heading = 229.64,
        radius = 0.7,
    },
...
Config.Drugs = {
    weed_package = { -- Item name
        ...
        ReportChance = 30, --Dispatch Chance 0 - 100 %
