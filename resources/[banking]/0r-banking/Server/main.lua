...
TwoNa.RegisterServerCallback("0r-banking:Server:GetUserAccounts", function(source, data, cb) 
...
TwoNa.RegisterServerCallback("0r-banking:Server:CreateAccount", function(source, data, cb) 
    local identifier = TwoNa.GetCharacterIdentifier(source)
...
TwoNa.RegisterServerCallback("0r-banking:Server:DeleteAccount", function(source, data, cb) 
    local identifier = TwoNa.GetCharacterIdentifier(source)
...
TwoNa.RegisterServerCallback("0r-banking:Server:DepositMoney", function(source, data, cb) 
    local identifier = TwoNa.GetCharacterIdentifier(source)
    local xPlayer = TwoNa.GetPlayer(source)
...
TwoNa.RegisterServerCallback("0r-banking:Server:WithdrawMoney", function(source, data, cb) 
    local identifier = TwoNa.GetCharacterIdentifier(source)
    local xPlayer = TwoNa.GetPlayer(source)
...
TwoNa.RegisterServerCallback("0r-banking:Server:TransferMoney", function(source, data, cb) 
    local identifier = TwoNa.GetCharacterIdentifier(source)
