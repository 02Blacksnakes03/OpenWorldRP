...
RegisterNetEvent("psv-chat:registerRPText")
AddEventHandler("psv-chat:registerRPText", function(data)
...
RegisterNetEvent("psv-chat:SynchronizeMusics", function(data, src)
    gMusics[src] = data
...
RegisterNetEvent("psv-chat:DestroyMusic", function(src)
    gMusics[src] = nil
...
RegisterNetEvent("psv-chat:BalanceInfoMessage", function(data)
    Koci.Client:SendReactMessage("ui:addMessage", {
        message = {
...
RegisterNetEvent("psv-chat:Client:HandleCallback", function(key, data)
