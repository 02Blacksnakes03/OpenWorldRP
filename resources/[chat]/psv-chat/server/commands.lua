RegisterCommand("police", function(source, args, rawCommand)
    ...
    Koci.Server:TriggerCallback("psv-chat:getCharacterInfo", source, {}, function(character)
        if character then
            if character.job.name == "police" then
                Koci.Server:TriggerCallback("psv-chat:sendJobMessages", source, {
                    job = "police",
                    message = {
                        type = "POLICE",
...
RegisterCommand("adminwhisper", function(source, args, rawCommand)
    ...
    if IsPlayerAceAllowed(source, "command") then
        Koci.Server:TriggerCallback("psv-chat:sendAdminMessages", source,
            {
                type = "ADMIN WHISPER",
...
RegisterCommand("announce", function(source, args, rawCommand)
    ...
    if IsPlayerAceAllowed(source, "command") then
        Koci.Server:TriggerCallback("psv-chat:sendAdminAnnounce", source,
            {
                type = "Announcement",
...
RegisterCommand("ooc", function(source, args, rawCommand)
    ...
    Koci.Server:TriggerCallback("psv-chat:sendMessages", source,
        {
            type = "OOC",
...
RegisterCommand("showidentity", function(source, args, rawCommand)
    Koci.Server:TriggerCallback("psv-chat:getCharacterInfo", source, {}, function(character)
        if character then
            Koci.Server:TriggerCallback("psv-chat:showIdentity", source, {
                type = "CHARACTER INFO",
...
RegisterCommand("yellowpages", function(source, args, rawCommand)
    ...
    Koci.Server:TriggerCallback("psv-chat:sendYellowPages", source,
        {
            type = "YELLOW PAGES",
...
RegisterCommand("whisper", function(source, args, rawCommand)
    ...
    Koci.Server:TriggerCallback("psv-chat:sendWhisperMessage", source,
        {
            target = targetId,
            message = {
                type = "WHISPER",
...
RegisterCommand("playmusic", function(source, args, rawCommand)
    ...
    Koci.Server:TriggerCallback("psv-chat:playMusicWithUrl", source,
        {
            url = url,
        }
    )
...
RegisterCommand("stopmusic", function(source, args, rawCommand)
    Koci.Server:TriggerCallback("psv-chat:stopMusic", source)
end)

RegisterCommand("musicvolume", function(source, args, rawCommand)
    local volume = args[1]
    Koci.Server:TriggerCallback("psv-chat:setMusicVolume", source,
        {
