...
RegisterNetEvent("psv-hud:Client:HandleCallback", function(key, data)
...
RegisterNetEvent("psv-hud:Client:OpenHudSettings", function()
    SetNuiFocus(true, true)
    Koci.Client:SendReactMessage("setRouter", "settings")
end)
RegisterNetEvent("psv-hud:Client:SetManualGear", function(newGear)
...
elseif GetResourceState("saltychat") == "started" then
    ...
    TriggerServerEvent("psv-hud:Server:ErrorHandle", "Setup your custom voice resource at: client/utils.lua")
