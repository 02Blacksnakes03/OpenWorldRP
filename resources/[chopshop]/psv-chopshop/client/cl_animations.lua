RegisterNetEvent('psv-chopshop:wheelanimation')
AddEventHandler('psv-chopshop:wheelanimation', function()
...
RegisterNetEvent('psv-chopshop:dooranimation')
AddEventHandler('psv-chopshop:dooranimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('psv-chopshop:trunkanimation')
AddEventHandler('psv-chopshop:trunkanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('psv-chopshop:hoodanimation')
AddEventHandler('psv-chopshop:hoodanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('psv-chopshop:wheelchopanim')
AddEventHandler('psv-chopshop:wheelchopanim', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('psv-chopshop:doorchopanim')
AddEventHandler('psv-chopshop:doorchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('psv-chopshop:hoodchopanim')
AddEventHandler('psv-chopshop:hoodchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('psv-chopshop:trunkchopanim')
AddEventHandler('psv-chopshop:trunkchopanim', function()
	local ped = PlayerPedId()
