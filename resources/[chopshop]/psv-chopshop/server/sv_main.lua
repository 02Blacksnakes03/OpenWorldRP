...
RegisterNetEvent("psv-chopshop:syncchopcars")
AddEventHandler("psv-chopshop:syncchopcars", SyncCars)
...
RegisterServerEvent('psv-chopshop:server:callCops')
AddEventHandler('psv-chopshop:server:callCops', function(type, bank, streetLabel, coords)
    local msg = ""
    ...
    TriggerClientEvent("psv-chopshop:client:robberyCall", -1, type, bank, streetLabel, coords)
    TriggerClientEvent("qb-phone:client:addPoliceAlert", -1, alertData)
end)

RegisterNetEvent("psv-chopshop:server:rewardplayer")
AddEventHandler("psv-chopshop:server:rewardplayer", GiveReward)

function SyncCars(list) 
	TriggerClientEvent('psv-chopshop:carlist', -1,list) 
end

RegisterNetEvent("psv-chopshop:server:chopdoor")
AddEventHandler("psv-chopshop:server:chopdoor", function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
	local door = "car_door"
	...
	if Player.Functions.GetItemByName(door) ~= nil then
		...
		TriggerClientEvent('psv-chopshop:doorchopanim', src)
		Citizen.Wait(12500)
		Player.Functions.AddItem(item, amount, false, info)
		TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items[item], "add")
	else
...
RegisterNetEvent("psv-chopshop:server:chopwheel")
AddEventHandler("psv-chopshop:server:chopwheel", function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
	...
	if Player.Functions.GetItemByName(wheel) ~= nil then
		...
		TriggerClientEvent('psv-chopshop:wheelchopanim', src)
		Citizen.Wait(14000)
		Player.Functions.AddItem(item, amount, false, info)
		TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items[item], "add")
	else
...
RegisterNetEvent("psv-chopshop:server:chophood")
AddEventHandler("psv-chopshop:server:chophood", function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
	local hood = "radiator" 
	...
	if Player.Functions.GetItemByName(hood) ~= nil then
		...
		TriggerClientEvent('psv-chopshop:hoodchopanim', src)
		Citizen.Wait(12500)
		Player.Functions.AddItem(item, amount, false, info)
		TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items[item], "add")
	else
...
RegisterNetEvent("psv-chopshop:server:choptrunk")
AddEventHandler("psv-chopshop:server:choptrunk", function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
	local trunk = "trunk"
	...
	if Player.Functions.GetItemByName(trunk) ~= nil then
		...
		TriggerClientEvent('psv-chopshop:trunkchopanim', src)
		Citizen.Wait(12500)
		Player.Functions.AddItem(item, amount, false, info)
		TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items[item], "add")
	else
