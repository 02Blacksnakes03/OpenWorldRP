...
--[[
    ...
    - How to use exports:
    exports["psv-interaction"]:showInteraction('KEY', 'TEXT')

    - Also, u can make an export, without the key like this:
    exports["psv-interaction"]:showInteraction('', 'TEXT')

    - or

    exports["psv-interaction"]:showInteraction(nil, 'TEXT')

    - Hiding interaction:
    exports["psv-interaction"]:hideInteraction()
