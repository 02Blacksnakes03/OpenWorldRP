...
local function connectToRadio(channel)
    ...
    if onRadio then
        if Config.VoiceSystem == "qb-voice" then
    ...
    if Config.VoiceSystem == "qb-voice" then
        exports["qb-voice"]:setRadioChannel(channel)
    elseif Config.VoiceSystem == "saltychat" then
...
RegisterNetEvent('psv-radio:use:client', function()
...
Citizen.CreateThread(function()
    -- Volume
	local volumeData = GetResourceKvpString('volume-psv-radio')
