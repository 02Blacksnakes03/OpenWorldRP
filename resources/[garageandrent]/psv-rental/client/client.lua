...
RegisterNUICallback('rent', function(data)
    QBCore.Functions.TriggerCallback('psv-rental:rent', function(status)
        if status then
...
function createCar(data)
    ...
    TriggerServerEvent('psv-rental:createCar', QBCore.Functions.GetVehicleProperties(vehicle),data.carName,GetVehicleNumberPlateText(vehicle),data.carDay)
end
