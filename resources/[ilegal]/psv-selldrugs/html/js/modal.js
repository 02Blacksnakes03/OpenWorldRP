...
function handleUserChoice(choice) {
    $('#modal').fadeOut();
    $.post('https://psv-selldrugs/modalChoice', JSON.stringify(choice));
}
...
function showDeleteConfirmationModal() {
    ...
    $('#modal-button-accept').off('click').on('click', function() {
        if (currentDisplayedConversationId !== undefined) {
            $.post('https://psv-selldrugs/playerDeletedConversation', JSON.stringify(currentDisplayedConversationId));
