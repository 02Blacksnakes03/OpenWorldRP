...
RegisterNetEvent('psv-truckrob:CustomNotify')
AddEventHandler('psv-truckrob:CustomNotify', function(message, type)
...
RegisterNetEvent('psv-truckrob:PoliceAlert')
AddEventHandler('psv-truckrob:PoliceAlert', function(coords)
