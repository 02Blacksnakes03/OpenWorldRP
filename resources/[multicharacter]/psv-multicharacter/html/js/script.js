        ...
        if (data.action == "ui") {
            ...
            if (data.toggle) {
                ...
                setTimeout(function(){
                    ...
                    $.post('https://psv-multicharacter/setupCharacters');
                    setTimeout(function(){
                        ...
                        $.post('https://psv-multicharacter/removeBlur');
                        SetLocal()
                    }, 500);
                }, 2000);
            } else {
...
$('.disconnect-btn').click(function(e){
    ...
    $.post('https://psv-multicharacter/closeUI');
    $.post('https://psv-multicharacter/disconnectButton');
});
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $.post('https://psv-multicharacter/cDataPed', JSON.stringify({
                cData: cDataPed
            }));
        } else {
            $(selectedChar).addClass("char-selected");
...
$(document).on('click', '#create', function (e) {
    ...
    $.post('https://psv-multicharacter/createNewCharacter', JSON.stringify({
        firstname: firstname,
        lastname: lastname,
...
$(document).on('click', '#accept-delete', function(e){
    $.post('https://psv-multicharacter/removeCharacter', JSON.stringify({
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('https://psv-multicharacter/selectCharacter', JSON.stringify({
