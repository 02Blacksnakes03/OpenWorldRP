...
local interactions = {}
-- opens the ui
RegisterNetEvent('psv-elevator:showmenu', function(playerId)
    SendNUIMessage({action = 'showlift'})
    SetNuiFocus(true, true)
end)
-- hides the ui
RegisterNetEvent('psv-elevator:hidemenu', function(playerId)
        ...
        options = {
            {
                ...
                action = function(entity, coords, args)
                    TriggerEvent('psv-elevator:showmenu')
                end,
            },
        }
    }
...
RegisterNUICallback('selectfloor', function(data, cb)
    ...
    if nearestElevator then
        ...
        if selectedFloor then
            ...
            TriggerEvent("psv-elevator:hidemenu")
        else
