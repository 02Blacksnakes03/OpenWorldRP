--- dpemotes by TayMcKenzieNZ, Mathu_Imn and MadsL, maintained by TayMcKenzieNZ ---
--- Download OFFICIAL version and updates ONLY at https://github.com/TayMcKenzieNZ/dpemotes ---
--- dpemotes is FREE and ALWAYS will be. STOP PAYING SCAMMY FUCKERS FOR SOMEONE ELSE'S WORK!!! ---

fx_version 'cerulean'
game 'gta5'
authors { '#', 'MadsL', '#', 'Community' }
description 'dpemotes V1.2.6'
lua54 'yes'
